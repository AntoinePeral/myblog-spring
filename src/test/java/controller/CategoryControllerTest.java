...
import org.wildcodeschool.myblog.security.SecurityConfig;
...
class CategoryControllerTest {
    ...
    void testGetCategoryById_CategoryNotFound() throws Exception {
        // Arrange
        when(categoryService.getCategoryById(99L)).thenThrow(new CategoryNotFoundException("Category not found"));
